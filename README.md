# Clash Guide
This is a Kotlin Multiplatform project targeting Android, Desktop. This app display all the available on the [API](https://github.com/prasidhanchan/clash-guide-api) Clash of Clans Troops along with their details.
